...
let s:insert0 = [ '#eceafa', 236 ]
let s:insert1 = [ '#cfc8f4', 238 ]
let s:insert2 = [ '#b4addf', 243 ]
let s:insert3 = [ '#a29acb', 255 ]
...
let s:warningfg = [ '#D08770', 236 ]
let s:errorfg = [ '#b55673', 236 ]
let s:warningbg = [ '#eceafa', 238 ]
let s:errorbg = [ '#eceafa', 238 ]
