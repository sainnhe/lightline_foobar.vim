...
" Filename: autoload/lightline/colorscheme/typewriter_dark.vim
" Author: Sainnhepark
...
let s:tab_r_fg = s:white2
let s:tab_r_bg = s:dark1
let s:tab_sel_fg = s:dark1
let s:tab_sel_bg = s:white1
let s:tab_middle_fg = s:white1
let s:tab_middle_bg = s:dark3
...
let s:normal_middle_fg = s:white1
let s:normal_middle_bg = s:dark3
...
let s:insert_middle_fg = s:white1
let s:insert_middle_bg = s:dark3
...
let s:visual_middle_fg = s:white1
let s:visual_middle_bg = s:dark3
...
let s:replace_r1_fg = s:visual_r1_fg
let s:replace_r1_bg = s:visual_r1_bg
let s:replace_r2_fg = s:visual_r2_fg
let s:replace_r2_bg = s:visual_r2_bg
let s:replace_middle_fg = s:white1
let s:replace_middle_bg = s:dark3

let s:inactive_l1_fg = s:white2
let s:inactive_l1_bg = s:dark1
let s:inactive_l2_fg = s:white2
let s:inactive_l2_bg = s:dark1
let s:inactive_r1_fg = s:white2
let s:inactive_r1_bg = s:dark1
let s:inactive_r2_fg = s:white2
let s:inactive_r2_bg = s:dark1
let s:inactive_middle_fg = s:white1
let s:inactive_middle_bg = s:dark3
"}}}
