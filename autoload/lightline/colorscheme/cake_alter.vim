...
" Filename: autoload/lightline/colorscheme/cake_alter.vim
" Author: Sainnhepark
...
let s:green = [ '#7eb833', 107 ]
let s:blue = [ '#0c8df0', 33 ]  " #75a1ff #7a8aff
let s:pink = [ '#e372e1', 170 ]
let s:orange = [ '#e87021', 166 ]
let s:red = [ '#d46a84', 14 ]
"}}}
...
let g:lightline#colorscheme#cake_alter#palette = lightline#colorscheme#flatten(s:p)
