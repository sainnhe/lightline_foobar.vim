...
" Filename: autoload/lightline/colorscheme/wwdc16_alter.vim
" Author: Sainnhepark
...
let s:green = [ '#95c76f', 76 ]  " #42a647
let s:cyan = [ '#00aba5', 14 ]
let s:base = [ '#8485ce', 121 ]
let s:violet = [ '#d24e9b', 205 ]
let s:red = [ '#e64547', 168 ]
let s:orange = [ '#c98351', 180 ]
let s:dark = [ '#292c36', 234 ]
let s:darker = [ '#353547', 235 ]
let s:white = [ '#fafafa', 255 ]
"}}}

"{{{Definition
let s:tab_l_fg = s:base
let s:tab_l_bg = s:darker
let s:tab_r_fg = s:white
let s:tab_r_bg = s:violet
let s:tab_sel_fg = s:white
let s:tab_sel_bg = s:base
let s:tab_middle_fg = s:violet
...
let s:normal_l1_bg = s:cyan
let s:normal_l2_fg = s:cyan
let s:normal_l2_bg = s:darker
let s:normal_r1_fg = s:white
let s:normal_r1_bg = s:cyan
let s:normal_r2_fg = s:cyan
let s:normal_r2_bg = s:darker
let s:normal_middle_fg = s:cyan
...
let g:lightline#colorscheme#wwdc16_alter#palette = lightline#colorscheme#flatten(s:p)
