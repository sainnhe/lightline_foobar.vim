...
" Filename: autoload/lightline/colorscheme/seoul256_alter.vim
" Author: Sainnhepark
...
let s:tab_r_fg = s:soft_light
let s:tab_r_bg = s:darker_bg
...
let g:lightline#colorscheme#seoul256_alter#palette = lightline#colorscheme#flatten(s:p)
