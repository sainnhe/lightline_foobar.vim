...
let s:normal_l1_bg = s:dark1
let s:normal_l2_fg = s:dark2
let s:normal_l2_bg = s:grey1
let s:normal_r1_fg = s:white1
let s:normal_r1_bg = s:dark1
let s:normal_r2_fg = s:dark2
let s:normal_r2_bg = s:grey1

let s:insert_l1_fg = s:white2
let s:insert_l1_bg = s:dark2
let s:insert_l2_fg = s:dark2
let s:insert_l2_bg = s:grey1
let s:insert_r1_fg = s:white2
let s:insert_r1_bg = s:dark2
let s:insert_r2_fg = s:dark2
let s:insert_r2_bg = s:grey1

let s:visual_l1_fg = s:white3
let s:visual_l1_bg = s:dark3
let s:visual_l2_fg = s:dark2
let s:visual_l2_bg = s:grey1
let s:visual_r1_fg = s:white3
let s:visual_r1_bg = s:dark3
let s:visual_r2_fg = s:dark2
let s:visual_r2_bg = s:grey1

let s:inactive_l1_fg = s:white1
let s:inactive_l1_bg = s:grey3
let s:inactive_l2_fg = s:dark2
let s:inactive_l2_bg = s:grey1
let s:inactive_r1_fg = s:white1
let s:inactive_r1_bg = s:grey3
let s:inactive_r2_fg = s:dark2
let s:inactive_r2_bg = s:grey1

let s:tab_l_fg = s:white1
let s:tab_l_bg = s:dark1
let s:tab_sel_fg = s:dark3
let s:tab_sel_bg = s:grey1
...
let s:middle_fg = s:dark1
let s:middle_bg = s:white3
