...
" Filename: autoload/lightline/colorscheme/typewriter_light.vim
" Author: Sainnhepark
...
let s:tab_r_fg = s:dark2
let s:tab_r_bg = s:white3
let s:tab_sel_fg = s:white3
let s:tab_sel_bg = s:dark3
let s:tab_middle_fg = s:dark3
let s:tab_middle_bg = s:white1
...
let s:normal_middle_fg = s:dark3
let s:normal_middle_bg = s:white1
...
let s:insert_middle_fg = s:dark3
let s:insert_middle_bg = s:white1
...
let s:visual_middle_fg = s:dark3
let s:visual_middle_bg = s:white1
...
let s:replace_middle_fg = s:dark3
let s:replace_middle_bg = s:white1
...
let s:inactive_middle_fg = s:dark3
let s:inactive_middle_bg = s:white1
"}}}
