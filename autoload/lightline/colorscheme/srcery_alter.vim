...
" Filename: autoload/lightline/colorscheme/srcery_alter.vim
" Author: Sainnhepark
...
let s:tab_r_fg = s:golden_light
let s:tab_r_bg = s:dark
let s:tab_sel_fg = s:dark
let s:tab_sel_bg = s:golden
let s:tab_middle_fg = s:golden_light
...
let s:normal_middle_fg = s:golden_light
...
let s:insert_middle_fg = s:golden_light
...
let s:visual_middle_fg = s:golden_light
...
let s:replace_r2_bg = s:golden
let s:replace_middle_fg = s:golden_light
...
let s:inactive_middle_fg = s:golden_light
